...
export const TEST_EC_KEY = KryptosKit.from.b64({
  id: "3e8ee69f-be8b-525b-91f0-153872bdbb79",
  algorithm: "ECDH-ES",
  curve: "P-521",
  privateKey:
...
export const TEST_OCT_KEY = KryptosKit.from.b64({
  id: "9762b62d-b081-5605-ab75-1c71d1b789bc",
  algorithm: "dir",
  privateKey:
...
export const TEST_OKP_KEY = KryptosKit.from.b64({
  id: "38bfeae2-08b1-5f0d-a662-33d4be867b26",
  algorithm: "ECDH-ES",
  curve: "X25519",
...
export const TEST_RSA_KEY = KryptosKit.from.b64({
  id: "5a69f035-4a65-5ea9-80db-e73601784e1b",
  algorithm: "RS512",
  privateKey:
