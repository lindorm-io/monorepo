...
describe("encoded-aes", () => {
  test("should consistently resolve string", () => {
    expect(
      ...
      "ATgkYzAzYjU4OWItMTI0ZC00NWViLTgzNzYtZDdmMDU3NjgxMWZmElBCRVMyLUhTNTEyK0EyNTZLVwdBMjU2R0NNEI7HALtUMpltqV0RpLGKxbwFmpTW97oM2R3KWgWuSS-u8_tmAAAASAABAAF21wEQqauzF1XQGmbtwtoIpVEFYQAAAQAAACih0D1-FgGCWx-9GuryEuwKzkVosB6n1yTq6rMFk4ApvZmrCUpKGFI_AA",
    );
  });
