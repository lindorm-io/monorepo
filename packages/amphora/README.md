...
| `openIdConfiguration` | `Partial<Configuration>`  | Override or supplement values from the discovery document.                                                                                    |
