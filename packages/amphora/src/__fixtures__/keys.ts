...
const defaults = {
  ...
  // Tests needing an INTERNAL key (KEK, cookie, CA) clone one with publish: false.
  publish: true,
};

const EC: KryptosFromString = {
  ...defaults,
  id: "3d432113-6fbe-5b28-8e23-01ff2120f374",
  algorithm: "ES512",
  curve: "P-521",
  privateKey:
...
const RSA: KryptosFromString = {
  ...defaults,
  id: "bee69414-2c15-5ec4-8620-a938af663ed3",
  algorithm: "RS512",
  privateKey:
