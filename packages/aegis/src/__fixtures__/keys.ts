...
const EC: KryptosFromString = {
  ...defaults,
  id: "de869dcc-f69c-5b79-9696-b0ba9b8b108a",
  algorithm: "ES512",
  curve: "P-521",
  privateKey:
...
const RSA: KryptosFromString = {
  ...defaults,
  id: "b891eb1a-51a1-5ce1-af62-ab2f6eae4ead",
  algorithm: "RS512",
  privateKey:
...
export const TEST_AKP_KEY_SIG = KryptosKit.clone(KRYPTOS_AKP_SIG_ML_DSA_65, {
  ...defaults,
