...
import { TEST_CACHE_IDENTIFIER } from "./cache.fixture";
import { CacheEventHandler } from "../handler";
import { CacheEventHandlerOptions } from "../types";
import {
...
export const TEST_CACHE_EVENT_HANDLER_OPTIONS: CacheEventHandlerOptions = {
  aggregate: {
    name: TEST_AGGREGATE_IDENTIFIER.name,
    context: TEST_AGGREGATE_IDENTIFIER.context,
  },
  cache: {
    name: TEST_CACHE_IDENTIFIER.name,
    context: TEST_CACHE_IDENTIFIER.context,
  },
...
export const TEST_CACHE_EVENT_HANDLER = new CacheEventHandler(TEST_CACHE_EVENT_HANDLER_OPTIONS);

export const TEST_CACHE_EVENT_HANDLER_CREATE = new CacheEventHandler({
  ...TEST_CACHE_EVENT_HANDLER_OPTIONS,
...
export const TEST_CACHE_EVENT_HANDLER_ADD_FIELD = new CacheEventHandler({
  ...TEST_CACHE_EVENT_HANDLER_OPTIONS,
...
export const TEST_CACHE_EVENT_HANDLER_DESTROY = new CacheEventHandler({
  ...TEST_CACHE_EVENT_HANDLER_OPTIONS,
...
export const TEST_CACHE_EVENT_HANDLER_REMOVE_FIELD_WHERE_EQUAL = new CacheEventHandler({
  ...TEST_CACHE_EVENT_HANDLER_OPTIONS,
...
export const TEST_CACHE_EVENT_HANDLER_REMOVE_FIELD_WHERE_MATCH = new CacheEventHandler({
  ...TEST_CACHE_EVENT_HANDLER_OPTIONS,
...
export const TEST_CACHE_EVENT_HANDLER_SET_STATE = new CacheEventHandler({
  ...TEST_CACHE_EVENT_HANDLER_OPTIONS,
...
export const TEST_CACHE_EVENT_HANDLER_THROWS = new CacheEventHandler({
  ...TEST_CACHE_EVENT_HANDLER_OPTIONS,
