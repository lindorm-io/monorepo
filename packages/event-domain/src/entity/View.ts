...
import { IView, ViewOptions, ViewData } from "../types";
...
export class View<State extends Record<string, any> = Record<string, any>> implements IView<State> {
  ...
  public constructor(options: ViewOptions<State>, logger: Logger) {
    ...
    this._state = options.state || ({} as State);
  }
