...
import { ICache, CacheOptions, CacheData, State } from "../types";
import { IllegalEntityChangeError, CacheDestroyedError } from "../error";
...
export class Cache<S extends State = State> implements ICache<S> {
