import { composeFetchConfig as _composeFetchConfig } from "#internal/utils/compose-fetch-config";
import { requestWithRetry as _requestWithRetry } from "#internal/utils/request-with-retry";
import { useFetch as _useFetch } from "#internal/utils/use-fetch";
import { fetchRequestHandler } from "./fetch-request-handler";

jest.mock("#internal/utils/compose-fetch-config");
jest.mock("#internal/utils/request-with-retry");
jest.mock("#internal/utils/use-fetch");
