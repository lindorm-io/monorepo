...
| `publish`                                       | Does this key belong in the published JWKS? Defaults to **`false`** — a minted key is unpublished until you say otherwise — and is never inferred from `purpose`. See [Publication](#publication).                                                                                                                                                     |
...
| `hasPrivateKey` / `hasPublicKey`                | Whether the underlying buffers are present and non-empty; `false` once the key is disposed.                                                                                                                                                                                                                                                            |
