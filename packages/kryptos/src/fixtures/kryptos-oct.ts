...
export const KRYPTOS_OCT_SIG_HS384 = KryptosKit.from.b64({
...
export const KRYPTOS_OCT_SIG_HS512 = KryptosKit.from.b64({
...
export const KRYPTOS_OCT_ENC = KryptosKit.from.b64({
