...
export const KRYPTOS_OKP_SIG_ED448 = KryptosKit.from.b64({
...
export const KRYPTOS_OKP_ENC_X25519 = KryptosKit.from.b64({
...
export const KRYPTOS_OKP_ENC_X448 = KryptosKit.from.b64({
