import { DefaultLindormKoaContext, LindormKoaMetadataHeaders } from "../../types";
import { MetadataHeader } from "../../enum";

export const getMetadataHeaders = (ctx: DefaultLindormKoaContext): LindormKoaMetadataHeaders => ({
