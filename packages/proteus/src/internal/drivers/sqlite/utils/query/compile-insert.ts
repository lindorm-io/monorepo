...
export const compileInsert = <E extends IEntity>(
  ...
  sharedCompileInsert(entity, metadata, sqliteDialect, deps, namespace, amphora);
...
export const compileInsertBulk = <E extends IEntity>(
  ...
  sharedCompileInsertBulk(entities, metadata, sqliteDialect, deps, namespace, amphora);
