...
import { truncateSuite } from "./truncate.tck.js";
import { destructiveCriteriaSuite } from "./destructive-criteria.tck.js";
...
const runTckForNaming = (
  ...
  truncateSuite(getHandle, entities);
  destructiveCriteriaSuite(getHandle, entities, caps);
