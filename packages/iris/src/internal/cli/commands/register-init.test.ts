...
describe("registerInitCommand", () => {
  ...
  it("should wire init as the action", async () => {
    ...
    await program.parseAsync(["node", "iris", "init", "-D", "rabbit"]);
  ...
  it("should pass --driver option through", async () => {
    ...
    await program.parseAsync(["node", "iris", "init", "--driver", "redis"]);
  ...
  it("should pass --directory option through", async () => {
    ...
    await program.parseAsync(["node", "iris", "init", "-D", "memory", "-d", "./custom"]);
