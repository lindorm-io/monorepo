...
export const TEST_ARRAY_BUFFER: any = new ArrayBuffer();
...
export const TEST_DATA_VIEW: any = new DataView(new ArrayBuffer(1));
export const TEST_DATE_STRING: any = new Date().toISOString();
export const TEST_DATE: any = new Date();
export const TEST_EMPTY_ARRAY: any = [];
...
export const TEST_MAP: any = new Map();
...
export const TEST_SET: any = new Set();
...
export const TEST_WEAK_MAP: any = new WeakMap();
export const TEST_WEAK_SET: any = new WeakSet();
