import { DefaultRecord, Protocol } from "../types";
...
const replaceParamWithValue = (input: string, params: DefaultRecord): string => {
...
const addParamsToPathname = (pathname: string, params: DefaultRecord): string => {
