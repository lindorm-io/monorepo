export const BROWSER_LINK_COOKIE_NAME = "lindorm_io_authentication_browser_link";
export const CONSENT_SESSION_COOKIE_NAME = "lindorm_io_authentication_consent_session";
